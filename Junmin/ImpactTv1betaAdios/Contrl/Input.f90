...
!          write(6,*)'onblem = ',onblem
        ...
        if(my_rank.eq.0) then
          write(6,*) onpcol,' cols by ',onprow,' rows Proc grid'
          write(6,*) onx,' X ',ony,' X ',onz,' Computation Grid'
          write(6,*) onp,' particles '
          write(6,*) ontstep,' timesteps '
          write(6,*) obcurr,' obcurr '
          call flush(6)
        endif
