...
102      format(8(1x,e16.8))
       ...
       ! Junmin 
       subroutine phase_Output(bpFileName, nfile,this,samplePeriod, timestep, totalstep)
         !!use sensei_util
        implicit none
        include 'mpif.h'
        ...
        call  utilAdiosOut(bpFileName, MPI_COMM_WORLD, this%Pts1, sumnpt, 6, this%Nptlocal, startnpt, timestep, totalstep);                
...
!subroutine phase_in(this, bpFilename, pts)
!subroutine phase_in(bpFilename, pts)
    implicit none
    include 'mpif.h'
